...
const host_remote = "https://test3-latest-dr8u.onrender.com";
...
async function signup() {
    ...
    let username = document.getElementById("usernamey").value;
    let password = document.getElementById("passy").value;
